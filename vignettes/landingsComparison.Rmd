...
We investigate the landings/catch time series for the Northeast USA Large Marine Ecosystem (NEUS LME). Data sources include:
...
This discrepency needs to be resolved
